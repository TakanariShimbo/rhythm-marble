...
Instagramリール用動画(9:16, 1080×1920, 30fps)を自動生成するパイプライン。

壁が割れてガラスのビー玉が現れ、音が鳴る瞬間ちょうどに金属板へ着弾しながら
落ちていく。休符ではゴムのレールを静かに転がる。額に入れたアートワークと
刻印タイトルが冒頭に映る(0秒フレーム=そのままサムネイルになる構図)。
